...
# from task_1 import create_tree, print_tree
# from task_2 import head_above_avg, unpack_name_and_year
# from task_3 import strip_ends, strip_chars
# from task_4 import a_method, Logger
# from tasks import task_1
from tasks import task_3
from tasks import task_16

# from task_10 import spawn_threads
# from task_12 import search_with_regex

# from task_16 import bubble_sort

ROOT = "ROOT"

FILE_PATH = "tasks/proc_dump.txt"
...
class VerifyTasks(unittest.TestCase):
    ...
    def test_task_3(self):
        arr = task_3.strip_ends([1, 3, 5, 7, 9])
        print(arr)
        self.assertEqual([3, 5 ,7], arr)

        self.assertEqual("Dsitki ikihrTs", task_3.strip_chars("Das ist kein wirklicher Test"))
